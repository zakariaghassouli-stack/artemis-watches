...
const FR_SPEC_VALUE_MAP: Record<string, string> = {
  'Bidirectional rotating, red/blue ceramic 24h': 'Tournante bidirectionnelle, céramique rouge/bleu 24 h',
  ...
  'Unidirectional rotating, 60-min ceramic': 'Tournante unidirectionnelle, céramique 60 min',
  'Unidirectional rotating, 60-min blue ceramic': 'Tournante unidirectionnelle, céramique bleue 60 min',
  ...
  'Five-piece links': 'Cinq maillons',
  'Three-piece solid links': 'Trois maillons pleins',
  ...
  'Hidden folding clasp': 'Fermoir déployant caché',
  ...
  'Folding clasp with safety lock': 'Fermoir déployant avec verrou de sécurité',
  'Folding clasp with extension': 'Fermoir déployant avec extension',
  Black: 'Noir',
  ...
  'Luminescent indices (blue)': 'Indices luminescents (bleus)',
};
