...
export function ProductInfo({
  ...
  return (
    ...
    >
      ...
      {/* CTAs - WhatsApp primary (Option A: DM-first 60d), Add to cart secondary */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <ContactCTA
          ...
          productContext={{
            ...
            price: activePrice + (resolvedBoxAndPapers ? boxAndPapersPrice : 0),
        ...
        <button
          ...
          style={{
            ...
            color: product.inStock ? '#C9A96E' : 'rgba(255,255,255,0.25)',
            fontSize: '0.72rem',
            fontWeight: 700,
          ...
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLButtonElement).style.borderColor = product.inStock
              ? 'rgba(201,169,110,0.35)'
              : 'rgba(255,255,255,0.08)';
            (e.currentTarget as HTMLButtonElement).style.color = product.inStock
              ? '#C9A96E'
