...
export const metadata: Metadata = {
  title: 'Order Confirmed | ARTEMIS Watches',
  description: 'Your ARTEMIS order is confirmed. Thank you for your purchase.',
  ...
  if (session_id) {
    try {
      ...
      if (session.payment_status === 'paid') {
        ...
        // Extract product IDs + item count from Stripe metadata for Pixel tracking
        try {
    ...
    <div style={{ background: '#0A0A0A', minHeight: '100vh' }}>
      ...
      >
        <div style={{ maxWidth: 560, width: '100%' }}>
          ...
          >
            {valid
              ? `Your order has been received and is being processed. A confirmation has been sent to ${customerEmail}.`
          ...
          >
            ...
            {[
              'We review your order and prepare your timepiece for shipment.',
              'You receive a tracking number via email within 24–48 hours.',
              'Your watch arrives in premium packaging with all included accessories.',
            ].map((step, i) => (
              <div
                key={i}
