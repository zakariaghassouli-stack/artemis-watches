...
export const metadata: Metadata = {
  ...
  description:
    'Freshly curated timepieces from Rolex, Cartier, Audemars Piguet, and Patek Philippe. New additions to the Artemis catalogue — Japanese and Dandong movement options.',
};
